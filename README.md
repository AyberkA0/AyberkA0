...
Git • GitHub • API testing • Developer tooling design • Custom editors
...
An AI-powered system where users define trading conditions and automation rules while the platform processes **real-time market data and financial news streams** to trigger actions. Includes highly secured and super-scalable infrastructure.
...
A low-level and language-agnostic library that makes financial data analysis easier, converts Pinescript codes to scalable Python 
codes and more additional functions.
